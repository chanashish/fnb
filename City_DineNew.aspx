<%@ Page Language="C#" AutoEventWireup="true" CodeFile="City_DineNew.aspx.cs" Inherits="City_DineNew" %>
...
<div class="modal" id="modal-name">
  ...
  <div class="modal-box">
    ...
    <%--<input type="text" placeholder="Search Your Location" />--%>
       <asp:TextBox ID="txtHotel"   placeholder="Search Your Location" runat="server" />
...
<script>
    $(".award").slick({
        ...
        <script>
            ...
            function GetByRestaurant() {
                ...
                var str1 = str.split("/");
                var loc = str1[4].replace('-restaurants', '').replace('#offer', '').replace('#', '');
               
                //alert(loc);
                $.post('City_DineNew.aspx', { CityName: loc, orderby: 'R' },
                       function (data) {
                           //alert(data);
            ...
            function GetByHotel() {
                ...
                var loc = str1[4].replace('-restaurants', '').replace('#offer', '').replace('#', '');
                // alert(loc);
                $.post('City_DineNew.aspx', { CityName: loc, orderby: 'H' },
                       function (data) {
                           $("#LitLocationDine").html(data);
                           //$("#Div1").html("");
                           $(".regular").slick({
            ...
            function GetC() {
                ...
                //alert(ctype);
                $.post('City_DineNew.aspx', { CityName: loc, CuisineType: ctype },
                       function (data) {
                           $("#LitLocationDine").html(data);
            ...
            function GetRes(sjid) {
               // alert(sjid);
                //var hid=sjid
                $.post('City_DineNew.aspx', { HotelID: sjid },
                      function (data) {
                          //alert(data);
                          $("#Div1").html(data);
                          $(".dish-slider").slick({
  ...
  <div class="modal-box">
	...
	<a  class="close" data-dismiss="modal">Close <i class="fas fa-chevron-down"></i></a>
        ...
        <asp:Panel ID="Panel1" runat="server" DefaultButton="BtnDine">
